 ...
 * @brief: Construct a schema from a vector of columns
 * @param columns: the vector of columns
 * @param is_keyed: whether the schema is keyed
 * @note: The schema should take ownership of the columns
 * @note: The schema should be keyed if and only if is_keyed is true
 * @note: The schema should be unkeyed if and only if is_keyed is false
 */
